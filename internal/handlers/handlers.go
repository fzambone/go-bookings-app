...
import (
	...
	"github.com/fzambone/go-bookings-app/internal/forms"
	"github.com/fzambone/go-bookings-app/internal/helpers"
	"github.com/fzambone/go-bookings-app/internal/models"
...
// PostAvailability posts form data in the availability page
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		m.App.ErrorLog.Println("Can't ger error from session")
